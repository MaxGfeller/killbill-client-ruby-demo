...
module SwaggerClient
  ...
  class PaymentJson
    ...
    def hash
      [account_id, payment_id, payment_number, payment_external_key, auth_amount, captured_amount, purchased_amount, refunded_amount, credited_amount, currency, payment_method_id, transactions, payment_attempts, audit_logs].hash
    end
