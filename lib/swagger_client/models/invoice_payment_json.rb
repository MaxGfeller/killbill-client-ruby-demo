...
module SwaggerClient
  ...
  class InvoicePaymentJson
    attr_accessor :target_invoice_id
    ...
    attr_accessor :purchased_amount
    ...
    def self.swagger_types
      {
        ...
        :'transactions' => :'Array<PaymentTransactionJson>',
        :'payment_attempts' => :'Array<PaymentAttemptJson>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'targetInvoiceId')
        self.target_invoice_id = attributes[:'targetInvoiceId']
      end
      ...
      if attributes.has_key?(:'authAmount')
        self.auth_amount = attributes[:'authAmount']
      end

      if attributes.has_key?(:'capturedAmount')
        self.captured_amount = attributes[:'capturedAmount']
      end

      if attributes.has_key?(:'purchasedAmount')
        self.purchased_amount = attributes[:'purchasedAmount']
      end
      ...
      if attributes.has_key?(:'creditedAmount')
        self.credited_amount = attributes[:'creditedAmount']
      end
      ...
      if attributes.has_key?(:'paymentAttempts')
        if (value = attributes[:'paymentAttempts']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          target_invoice_id == o.target_invoice_id &&
          ...
          purchased_amount == o.purchased_amount &&
    ...
    def hash
      [target_invoice_id, account_id, payment_id, payment_number, payment_external_key, auth_amount, captured_amount, purchased_amount, refunded_amount, credited_amount, currency, payment_method_id, transactions, payment_attempts, audit_logs].hash
    end
